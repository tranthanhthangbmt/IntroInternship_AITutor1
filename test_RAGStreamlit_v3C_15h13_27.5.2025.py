...
#---------------------------
#run: streamlit run test_RAGStreamlit_v3C_15h13_27.5.2025.py
#run2: streamlit run --server.fileWatcherType none test_RAGStreamlit_v3C_15h13_27.5.2025.py
#------------------
...
vectorstore = FAISS.load_local(
    ...
    "IntroInternshipRAG_MiniLM_L3_withEbooks/faiss_index",
